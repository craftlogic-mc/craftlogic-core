...
public abstract class MixinVillageHouseBlacksmith extends StructureVillagePieces.Village {
    ...
    public boolean addComponentParts(World world, Random rand, StructureBoundingBox boundings) {
        ...
        this.setBlockState(world, Blocks.FURNACE.getDefaultState(), 6, 2, 3, boundings);
        this.setBlockState(world, Blocks.FURNACE.getDefaultState(), 6, 3, 3, boundings);
        ...
        this.setBlockState(world, fence, 2, 1, 4, boundings);
