...
public class Vector3 {
    ...
    public static final Vector3 BLOCK_CENTER = new Vector3(0.5, 0.5, 0.5);

    public static final Vector3 UNIT_X = new Vector3(1, 0, 0);
    public static final Vector3 UNIT_Y = new Vector3(0, 1, 0);
    public static final Vector3 UNIT_Z = new Vector3(0, 0, 1);
    
    public static final Vector3 UNIT_NX = new Vector3(-1, 0, 0);
    public static final Vector3 UNIT_NY = new Vector3(0, -1, 0);
    public static final Vector3 UNIT_NZ = new Vector3(0, 0, -1);
    
    public static final Vector3 UNIT_PYNZ = new Vector3(0, 0.707, -0.707);
    public static final Vector3 UNIT_PXPY = new Vector3(0.707, 0.707, 0);
    public static final Vector3 UNIT_PYPZ = new Vector3(0, 0.707, 0.707);
    public static final Vector3 UNIT_NXPY = new Vector3(-0.707, 0.707, 0);
    ...
    public static final Vector3[][] FACE_BASES = {
        {UNIT_X, UNIT_Z}, // DOWN
        {UNIT_X, UNIT_NZ}, // UP
