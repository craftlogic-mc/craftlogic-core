...
public class SizeCheckedInventoryManager extends WrappedInventoryManager {
    public SizeCheckedInventoryManager(IInventory inventory) {
        super(inventory);
    }

    public SizeCheckedInventoryManager(IInventory inventory, IntConsumer updateListener) {
