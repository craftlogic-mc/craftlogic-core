...
public class ListInventoryManager implements InventoryManager {
    private final NonNullList<ItemStack> inventory;
    private final IntConsumer updateListener;

    public ListInventoryManager(NonNullList<ItemStack> inventory) {
        this(inventory, null);
    }

    public ListInventoryManager(NonNullList<ItemStack> inventory, IntConsumer updateListener) {
